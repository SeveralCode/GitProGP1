...
#ifdef DLL_EXPORT
#define MATH_HELPER_API __declspec(dllexport)
#else
#define MATH_HELPER_API __declspec(dllimport)
#endif
...
public:
	...
	float operator[](const VectorAxis index)const
	{
